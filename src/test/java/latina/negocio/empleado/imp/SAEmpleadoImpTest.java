...
class SAEmpleadoImpTest {
    ...
    void testCorreoRepetido() {
        ...
        when(stubQueryBuscarPorDni.getResultList()).thenReturn(emptyList);
    ...
    void testTelefonoFormatoIncorrecto() {
        ...
        TEmpleado stubEmpleado = new TEmpleado("12345678C", "Nombre", "Apellidos", "nuevo@example.com", "12345", true);
    ...
    void testAltaEmpleadoExitoso() {
        ...
        TEmpleado stubEmpleado = new TEmpleado("12345678D", "Nombre", "Apellidos", "valido@example.com", "987654321", true);
    ...
    @Test
    void testGetEmpleadosDisponiblesSuccess() {
        // Mockear el Turno
        ...
        TEmpleado tEmpleado1 = new TEmpleado("12345678E", "Juan", "Pérez", "juan@example.com", "123456789", true);
    ...
    @Test
    void testGetEmpleadosDisponiblesEmpty() {
        // Mockear el Turno
        Turno stubTurno = mock(Turno.class);
        Timestamp fechaInicio = new Timestamp(System.currentTimeMillis());
        Timestamp fechaFin = new Timestamp(fechaInicio.getTime() + 3600000); // 1 hora después
